...
public enum DefaultFontInfo {
    ...
    NUM_9('9', 5), NUM_0('0', 5), EXCLAMATION_POINT('!', 1),
    AT_SYMBOL('@', 6), NUM_SIGN('#', 5), DOLLAR_SIGN('$', 5),
    PERCENT('%', 5), UP_ARROW('^', 5), AMPERSAND('&', 5),
    ASTERISK('*', 5), LEFT_PARENTHESIS('(', 4), RIGHT_PERENTHESIS(')', 4),
    ...
    LEFT_ARROW('<', 4), RIGHT_ARROW('>', 4), QUESTION_MARK('?', 5), SLASH('/', 5),
