...
public class FileManager {
    ...
    public FileManager(Plugin plugin, String outputFile, String inputFile) {
        this.plugin = plugin;
        this.outputFile = outputFile.contains(".yml") ? outputFile : outputFile + ".yml";
        this.inputFile = inputFile.contains(".yml") ? inputFile : inputFile + ".yml";
    ...
    public void clearFile() {
        for (String key : getFile().getKeys()) {
            getFile().set(key, null);
        }
        saveFile();
    }
}
